    ...
    topics: [
      ...
      /* ---------------- 5. Romeo & Juliet ---------------- */
      {
        ...
        lesson: [
          ...
          { h: "How the story unfolds" },
          { p: "Romeo, lovesick for **Rosaline**, crashes the **Capulet ball**, meets Juliet, and that same night they trade vows at the **balcony**. **Friar Laurence** secretly marries them, hoping the union will end the feud. Then **Tybalt kills Mercutio**, Romeo kills Tybalt in revenge, and the Prince **banishes Romeo** to Mantua. That killing-and-banishment is the **turning point (climax)**." },
          { p: "To escape marrying **Paris**, Juliet drinks the Friar's potion and **appears dead** for about 42 hours. The Friar's letter never reaches Romeo, so **Balthasar** brings him the false news that she has died. Romeo buys **poison** from an apothecary, kills Paris at the tomb, and drinks it. Juliet wakes, finds him dead, and **stabs herself** with his dagger. Their deaths finally **reconcile** the two families." },
          { h: "Big themes" },
          { defs: [
            ["Love vs. hate", "Tender love runs straight into an 'ancient grudge', the play's central tension."],
            ["Fate", "The lovers are 'star-crossed', doomed by the stars from the Prologue onward."],
            ["Haste", "The Friar warns 'they stumble that run fast'; rushing in drives the tragedy."],
            ["Youth vs. age", "The young lovers clash with their elders' feud, demands, and timetable."],
          ] },
          { h: "Devices the play is famous for" },
          { defs: [
            ["Oxymoron", "Contradictions like 'O loving hate' and 'parting is such sweet sorrow.'"],
            ["Dramatic irony", "We know Juliet is only drugged while Romeo believes she is truly dead."],
            ["Soliloquy", "A character alone shares private thoughts, like Juliet's balcony speech."],
            ["Metaphor", "'It is the east, and Juliet is the sun', a direct comparison, no 'like/as.'"],
            ["Pun", "Dying Mercutio jokes he'll be 'a grave man' (serious / in a grave)."],
            ["Allusion", "References to mythology, Cupid, Phoebus, Echo."],
            ["Sonnet", "The Prologue is a 14-line Shakespearean sonnet spoken by the Chorus."],
          ] },
          { tip: "'**Wherefore** art thou Romeo?' means '**why** are you a Montague', not 'where are you.'" },
        ],
        visual: {
        ...
        cards: [
          ...
          { front: "Who is Romeo in love with BEFORE Juliet?", back: "Rosaline." },
          { front: "What is the climax (turning point) of the play?", back: "Romeo kills Tybalt and is banished to Mantua (Act 3)." },
          { front: "How does Friar Laurence plan to save Juliet from marrying Paris?", back: "A potion that makes her appear dead for about 42 hours." },
          { front: "Why does Romeo think Juliet is really dead?", back: "The Friar's message fails to reach him; Balthasar reports her 'death.'" },
          { front: "How do Romeo and Juliet each die?", back: "Romeo drinks poison from an apothecary; Juliet stabs herself with his dagger." },
          { front: "What does 'star-crossed lovers' mean?", back: "Lovers doomed by fate / the stars." },
          { front: "'Parting is such sweet sorrow' is what device?", back: "An oxymoron (two opposite ideas joined)." },
          { front: "What is the Queen Mab speech?", back: "Mercutio's witty speech about a fairy who brings people dreams." },
          { front: "Who speaks the play's final lines ('a story of more woe')?", back: "Prince Escalus." },
          { front: "What finally ends the feud?", back: "The deaths of Romeo and Juliet reconcile the families." },
        ],
        questions: [
      ...
      /* ---------------- 6. The studied poems ---------------- */
      {
        ...
        cards: [
          ...
          { front: "Poet of \"Fog\"", back: "Carl Sandburg." },
          { front: "Poet of \"The Road Not Taken\"", back: "Robert Frost." },
          { front: "Poet of \"A Narrow Fellow in the Grass\"", back: "Emily Dickinson." },
          { front: "Poet of the Daffodils poem (\"I Wandered Lonely as a Cloud\")", back: "William Wordsworth." },
          { front: "Which 3 studied poems use an extended metaphor?", back: "\"Fog\" (fog = cat), \"The Road Not Taken\" (roads = life's choices), \"The Seven Ages of Man\" (life = a play)." },
          { front: "\"A Narrow Fellow\": theme", back: "Nature inspires both wonder and fear ('zero at the bone')." },
        ],
        questions: [
      ...
      /* ---------------- 9. Grammar ---------------- */
      {
        ...
        cards: [
          ...
          { front: "FANBOYS stands for...", back: "For, And, Nor, But, Or, Yet, So (the coordinating conjunctions)." },
          { front: "Three ways to fix a comma splice", back: "Use a period, a semicolon, or a comma + a FANBOYS conjunction." },
        ],

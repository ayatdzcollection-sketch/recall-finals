  ...
  STUDY.register({
    ...
    topics: [
      ...
      /* 8. Lizard / applied natural selection */
      {
        ...
        questions: [
          { type: "mc", q: "What event originally isolated the two lizard populations?", choices: ["A disease outbreak", "Volcanic eruptions that created impassable lava trenches", "Humans moving them", "A change in their diet"], answer: 1 },
          { type: "mc", q: "Two populations being separated by a physical divide so they cannot mate is called:", choices: ["a reproductive barrier", "geographic isolation", "a population bottleneck", "an adaptation"], answer: 1 },
          { type: "mc", q: "The two species have different dewlap colors, so they won't mate with each other. This is an example of a:", choices: ["geographic isolation", "reproductive barrier", "selection pressure", "mutation"], answer: 1 },
          { type: "mc", q: "Why are hybrid lizards unlikely to survive in the wild?", choices: ["They are born with a disease", "Their patchy coloration makes them highly visible to predators in either environment", "They cannot eat insects", "They are too large"], answer: 1 },
          { type: "mc", q: "The two lizard species share 98% identical DNA. This most likely means they:", choices: ["are unrelated", "recently diverged from a common ancestor", "are the same species", "were created by humans"], answer: 1 },
        ],
      },
